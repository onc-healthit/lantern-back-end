...
func setup() error {
	...
	endpoints, err = fetcher.GetEndpointsFromFilepath("../../../endpointmanager/resources/EpicEndpointSources.json", "FHIR", "Epic", "https://epwebapps.acpny.com/FHIRproxy/api/FHIR/DSTU2/")
