  ...
  dashboardBody(
    tabItems(
      ...
      tabItem("about_tab",
              ...
              p("For information about the data sources, algorithms, and query intervals used by Lantern, please see the", a("documentation available here.", href= "Lantern_Data_Sources_And_Algorithms.pdf")))
      ),
      div(class = "footer",
