...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(id = "side_menu",
      ...
      menuItem("CapabilityStatement / Conformance Values", icon = tags$i(class = "fa fa-table", "aria-hidden" = "true", role = "presentation", "aria-label" = "table icon"), tabName = "values_tab"),
