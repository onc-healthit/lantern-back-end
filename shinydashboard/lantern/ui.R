...
ui <- shinydashboardPlus::dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(id = "side_menu",
      ...
      menuItem("CapabilityStatement Dashboard", icon = tags$i(class = "fa fa-table", "aria-hidden" = "true", role = "presentation", "aria-label" = "list icon"), tabName = "capstat_dash_tab"),
  ...
  uiOutput("page_header"),
    ...
    tabItems(
      ...
      tabItem("fields_tab",
        ...
        tabItem("capstat_dash_tab",
              capstatdashboardmodule_UI("capstat_dashboard_page")
        ),
        tabItem("profile_tab",
