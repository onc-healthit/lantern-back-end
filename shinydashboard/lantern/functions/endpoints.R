...
vendor_short_names <- data.frame(
  vendor_name = c("Allscripts", "Cerner Corporation", "Epic Systems Corporation", "Medical Information Technology, Inc. (MEDITECH)", "Unknown"),
  short_name = c("Allscripts", "Cerner", "Epic", "MEDITECH", "Unknown"),
