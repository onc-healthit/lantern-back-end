...
func Test_RunIncludedFieldsAndExtensionsChecks(t *testing.T) {
	...
	th.Assert(t, includedFields[33].Exists == false, "Expected capabilitystatement expectation extension in includedFields to be false, was true")
	th.Assert(t, includedFields[35].Exists == true, "Expected DSTU2oauth-uris extension in includedFields to be true, was false")
	th.Assert(t, includedFields[34].Exists == false, "Expected conformance-prohibited extension in includedFields to be false, was true")
	...
	th.Assert(t, includedFields[48].Exists == true, "Expected capabilities extension in includedFields to be true, was false")
	th.Assert(t, includedFields[48].Field == "capabilities", fmt.Sprintf("Expected field to be capabilities, was %s", includedFields[48].Field))
	th.Assert(t, includedFields[40].Exists == true, "Expected capabilitystatement-search-parameter-combination extension in includedFields to be true, was false")
	th.Assert(t, includedFields[40].Field == "capabilitystatement-search-parameter-combination", fmt.Sprintf("Expected field to be capabilitystatement-search-parameter-combination, was %s", includedFields[40].Field))
	th.Assert(t, includedFields[41].Exists == true, "Expected capabilitystatement-supported-system extension in includedFields to be true, was false")
	th.Assert(t, includedFields[41].Field == "capabilitystatement-supported-system", fmt.Sprintf("Expected field to be capabilitystatement-supported-system, was %s", includedFields[41].Field))
	th.Assert(t, includedFields[42].Exists == true, "Expected capabilitystatement-websocket extension in includedFields to be true, was false")
	th.Assert(t, includedFields[42].Field == "capabilitystatement-websocket", fmt.Sprintf("Expected field to be capabilitystatement-websocket extension, was %s", includedFields[42].Field))
	...
	th.Assert(t, includedFields[43].Exists == true, "Expected resource-approvalDate extension in includedFields to be true, was false")
	th.Assert(t, includedFields[43].Field == "resource-approvalDate", fmt.Sprintf("Expected field to be resource-approvalDate, was %s", includedFields[43].Field))
	th.Assert(t, includedFields[44].Exists == true, "Expected resource-effectivePeriod extension in includedFields to be true, was false")
	th.Assert(t, includedFields[44].Field == "resource-effectivePeriod", fmt.Sprintf("Expected field to be resource-effectivePeriod, was %s", includedFields[44].Field))
	th.Assert(t, includedFields[45].Exists == true, "Expected resource-lastReviewDate extension in includedFields to be true, was false")
	th.Assert(t, includedFields[45].Field == "resource-lastReviewDate", fmt.Sprintf("Expected field to be resource-lastReviewDate, was %s", includedFields[45].Field))
	...
	th.Assert(t, includedFields[46].Field == "capabilitystatement-expectation", fmt.Sprintf("Expected field to be capabilitystatement-expectation, was %s", includedFields[46].Field))
	...
	th.Assert(t, includedFields[47].Field == "capabilitystatement-prohibited", fmt.Sprintf("Expected field to be capabilitystatement-prohibited, was %s", includedFields[47].Field))
