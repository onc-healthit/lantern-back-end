...
lint_go:
# Updated for golangci-lint v2.0.2
	cd ./capabilityquerier; golangci-lint run --timeout=3m
	cd ./lanternmq; golangci-lint run --timeout=3m
	cd ./endpointmanager; golangci-lint run --timeout=3m
	cd ./capabilityreceiver; golangci-lint run --timeout=3m
