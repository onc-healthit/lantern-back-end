...
ALTER TABLE fhir_endpoints_info ALTER COLUMN availability TYPE DECIMAL(5,4);
ALTER TABLE fhir_endpoints_info ALTER COLUMN response_time_seconds TYPE DECIMAL(7,4);

ALTER TABLE fhir_endpoints_info_history ALTER COLUMN availability TYPE DECIMAL(5,4);
ALTER TABLE fhir_endpoints_info_history ALTER COLUMN response_time_seconds TYPE DECIMAL(7,4);
