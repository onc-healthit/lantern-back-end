...
DROP INDEX IF EXISTS mv_validation_results_plot_vendor_idx;
DROP INDEX IF EXISTS mv_validation_results_plot_fhir_idx;
DROP INDEX IF EXISTS mv_validation_results_plot_rule_idx;
DROP INDEX IF EXISTS mv_validation_results_plot_valid_idx;
DROP INDEX IF EXISTS mv_validation_results_plot_reference_idx;
DROP MATERIALIZED VIEW IF EXISTS mv_validation_results_plot;
